        ...
        <div class="addtelephone">
            <div class="telephone modal-body">
                <div class="content-wrap content-box3">
                    ...
                    <h3>修改绑定手机</h3>
                    <form>
                        <label class="tlabel" for="realName">
                        ...
                        <button type="button" class="JSbtnsubmit" @click="setPhone">下一步</button>
                    </form>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods:{
        ...
        close(){
            document.querySelector('#changephone').style.cssText="display:none"
            this.error = '';
        },
    },
    computed:{
